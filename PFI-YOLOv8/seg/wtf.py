...
# 文件夹路径
image_folder = r'./datasets/PFI-1014/val2/images'
label_folder = r'./datasets/PFI-1014/val2/labels'
...
for label_file in os.listdir(label_folder):
    ...
    cv2.imencode('.jpg', mask_overlay)[1].tofile(output_path)
